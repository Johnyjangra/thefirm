...
import psvg from "../assets/images/svg/psvg.svg";

const Footer = () => {
  return (
    <section className="mt-5 pt-5">
      <Container className="mt-5 pt-5">
        <div className="mx_707 pt-5 mx-auto">
          <div className="text-center">
            <img src={logo} alt="logo" />
          </div>
          <ul className=" d-flex flex-wrap ps-0 mb-0 align-items-sm-center justify-content-sm-between pt-5">
            <li>
              <a
          ...
          <Row className="justify-content-center pt-5 ">
            ...
            <Col xs={1} className="ms-sm-0 ms-3">
              <svg
                width="25"
                height="20"
                viewBox="0 0 25 20"
          ...
          <p className="ff_nunito fw_400 fs_sm  clr_grey text-center py_43">
